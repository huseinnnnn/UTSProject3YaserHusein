...
<form method="post" action="/jabatan/{{ $jabatan->id_jabatan }}">
    @method('PUT')
    @csrf
    <div class="mb-2">
      <label for="nama" class="form-label">Nama Jabatan</label>
      <input type="text" class="form-control @error('nama_jabatan') is-invalid @enderror" name="nama_jabatan" value="{{ $jabatan->nama_jabatan, old('nama_jabatan')}}">
      @error('nama_jabatan')
